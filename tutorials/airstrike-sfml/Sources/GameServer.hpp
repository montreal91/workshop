...
public:
    ...
    void notifyPlayerRealtimeChange(
...
private:
    // A GameServer::RemotePeer refers to one instance of the game,
    // may it be local or from another computer.
    struct RemotePeer {
        RemotePeer();
        sf::TcpSocket           socket;
    ...
    void        handleIncomingPacket(
        sf::Packet& packet, RemotePeer& recievingPeer, bool& detectedTimeout
    );
